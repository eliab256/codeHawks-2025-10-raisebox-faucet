...
import {AttackerCrossReentrnatContract} from "./AttackerCrossReentrnatContract.sol";
...
contract TestRaiseBoxFaucet is Test {
    ...
    AttackerCrossReentrnatContract attackerCrossReentrnatContract;
...
//audit test    
    ...
    function testElseThatSetDailyDripsToZeroIsWrong() public {
        uint256 ethSentToEachAccount = raiseBoxFaucet.sepEthAmountToDrip();
        ...
        vm.prank(user3);
        raiseBoxFaucet.claimFaucetTokens();
        assertEq(raiseBoxFaucet.dailyDrips(), ethSentToEachAccount * 3);
        // vm.prank(user1);
        // raiseBoxFaucet.claimFaucetTokens();
        // assertEq(raiseBoxFaucet.dailyDrips(), ethSentToEachAccount * 0);
        vm.prank(user4);
        raiseBoxFaucet.claimFaucetTokens();
        assertEq(raiseBoxFaucet.dailyDrips(), ethSentToEachAccount * 4);
    ...
    */
    ...
    //  function testDOSDueToAttackerCrossAccountReentrancyToReachDailyClaimLimit() public {
    //     //preparation
    //     vm.startPrank(owner);
    //     raiseBoxFaucet.burnFaucetTokens(1);
    //     raiseBoxFaucet.mintFaucetTokens(address(raiseBoxFaucet), 1000000000000 * 10 **18);
    ...
    //     assertEq(attackerFinalTokenBalance, (raiseBoxFaucet.faucetDrip() * raiseBoxFaucet.dailyClaimLimit())); 
    //     assertEq(attackerFinalEthBalance, attackerInitialEthBalance + (raiseBoxFaucet.sepEthAmountToDrip() * raiseBoxFaucet.dailyClaimLimit()) );
    //     assertEq(raiseBoxFaucet.dailyClaimLimit(), raiseBoxFaucet.dailyClaimCount());
